...
<li class="header-search header-search-dropdown has-icon has-dropdown menu-item-has-children">
	...
	<a href="#" aria-label="<?php echo __('Search','woocommerce'); ?>" class="<?php echo get_flatsome_icon_class(flatsome_option('search_icon_style'), 'small'); ?>"><?php echo get_flatsome_icon('icon-search'); ?><span class="_5fuf">Tìm kiếm</span></a>
