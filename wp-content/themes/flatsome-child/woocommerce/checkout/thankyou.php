...
?>
<section class="_1box section">
	<div class="section-bg fill"></div>
	<div class="section-content relative">
        <div class="row row-small">
            <div class="col large-12 medium-12 small-12 RemovePaddingBottom">
                <div class="col-inner">
                    <h3 class="_4ajn">Đặt hàng thành công!</h3>
                    <p class="_0hvp">Cảm ơn bạn đã tin tưởng và lựa chọn <strong>5 LACQUER!</strong></p>
                    <p class="_1itc">Chúng tôi rất vinh hạnh được đồng hành cùng bạn trong hành trình khám phá nghệ thuật. Đơn hàng của bạn đang được xử lý và sẽ sớm được giao đến tận tay bạn. Chúc bạn có những phút giây thưởng thức nghệ thuật thật ý nghĩa!</p>
                </div>
            </div>
        </div>
	</div>
